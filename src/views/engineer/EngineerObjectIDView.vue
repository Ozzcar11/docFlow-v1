<template>
   <div class="create">
      ...
      <div class="button__container">
         <base-select v-model="engineer.value" @change="disableSelectHandler()" :options="engineer.data">
            Юрист</base-select>
         <br>
...
export default {
   ...
   methods: {
      ...
      disableSelectHandler1() {
         this.disabledNextBtn.engineer1 = false
      },
      async fetchObject() {
      ...
      async fetchEnginer() {
         ...
         const dataLawier = reLawier.data
         for (let item of dataLawier)
