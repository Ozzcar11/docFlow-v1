<template>
  <div v-if="!$route.meta.hideParent" class="represent">
    <base-headline>Представители</base-headline>
    <app-table :tableHeadline="tableHeadline" :tableRows="tableRows">
      <template #action="{ item }">
        <router-link
          style="padding: 7px 20px"
          :to="'/fin-dir/represent/' + item"
          class="table-btn"
        >
          <svg
            width="18"
    ...
    <base-button to="/fin-dir/represent/add" style="margin-top: 30px"
